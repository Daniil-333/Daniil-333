# Портфолио <img src="https://github.com/blackcater/blackcater/raw/main/images/Hi.gif" height="32"/>
## Меня зовут Даниил, я Fullstack-разработчик
...
### Стек Laravel-Inertia-Vue-TypeScript

| Название   | Описание                                                                                                                                                                                                                                                                                                                                                                        | Ссылка                                                    | Год  |
|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|------|
| Pet-проект | Портал для размещения видео и статей.  <ul>             <li>Регистрация только для пользователей из "белого списка"</li>             <li>Пагинация с сортировкой и фильтрацией</li>             <li>Капча при регистрации</li>             <li>Админ-панель на Moonshine (*креды не указал во избежание спама*)</li>           </ul>   [Ссылка (сайт)](https://guru4web.online) | [Ссылка (код)](https://github.com/Daniil-333/portal-test) | 2026 |
...
<p>Период работы с апреля 2021 года по февраль 2022 года. 
  Стек PHP-JS</p>
<table>
  <tr>
    <td>Название</td>
